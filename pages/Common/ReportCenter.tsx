      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden flex flex-col">
           <div className="p-6 bg-slate-50/50 border-b">
              <h3 className="text-xs font-black uppercase text-slate-800 tracking-widest">Ranking de Consumo</h3>
           </div>
                ...
                <div key={cat} className="group">
                   <div className="flex justify-between items-end mb-3">
                      <div>
                        ...
                        <p className="text-[9px] font-bold text-slate-400 uppercase">Consumo Total</p>
                      </div>
                   ...
                   <div className="w-full h-3 bg-slate-50 rounded-full overflow-hidden shadow-inner">
                      <div className="h-full bg-blue-600" style={{ width: `${(total / maxCatTotal) * 100}%` }}></div>
                   </div>
                </div>
              ))}
           </div>
